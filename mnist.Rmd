...
```{r load_MNIST, message=FALSE, warning=FALSE, include=FALSE}
...
X = matrix(rexp(500, rate=.1), ncol=10)

# 1. scale and center
xs = scale(X, scale=T, center=T)

# 2.  calculate covariance matrix
S = cov(xs)

# 3. calculate cov eigenvectors
ev = eigen(S)


prc = prcomp(X, scale=T)

ev$vectors
prc$rotation

# 4. calculate X(nxp) @ eigenvectors(pxp) - this is the PCA matrix
XS = (xs %*% ev$vectors)
...
<br>
```{r pca plot, echo=FALSE, message=FALSE, warning=FALSE, fig.align="center"}
...
```{r 1.1 Classifiers Logistic, message=FALSE, warning=FALSE, include=FALSE}
...
<br>
```{r 1.2 Confusion Matrix function, echo=FALSE, fig.height=15, fig.width=15, message=FALSE, warning=FALSE}
...
```{r 1.2 Confusion Matrix calc, echo=FALSE, fig.height=15, fig.width=15, message=FALSE, warning=FALSE}
...
```{r 1.2 Confusion Matrix test, echo=FALSE, fig.height=15, fig.width=15, message=FALSE, warning=FALSE}
par(mfrow=c(2,2))
...
<br>
```{r 1.3 ROC_data, message=FALSE, warning=FALSE, include=FALSE}
...
```{r roc plot, echo=FALSE, fig.height=5, fig.width=10, message=FALSE, warning=FALSE, fig.align="center"}
...
<br>
```{r 1.4 Classified Examples, echo=FALSE, fig.align="center", message=FALSE, warning=FALSE}
...
```{r Negative Digit, echo=FALSE, fig.align="center",fig.width=8, fig.height=6, message=FALSE, warning=FALSE, paged.print=FALSE}
...
```{r echo=FALSE, fig.height=15, fig.width=15, message=FALSE, warning=FALSE, paged.print=FALSE}
